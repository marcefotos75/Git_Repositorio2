...
def connect():
    ...
    server='MARCE-PC\SQLEXPRESS'
    database = 'agenda' 
    username = 'MARCE-PC\Marce' 
    password = ''

    try:
        conexion = pyodbc.connect('Trusted_Connection=Yes;DRIVER={SQL Server};SERVER='+server+';DATABASE='+database+';UID='+username+';PWD='+ password)
